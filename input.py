...
from printing import indent, line
    ...
    while True:
        ...
        try:
            ...
            if site_choice in [1, 2]:
                ...
                indent("Введите 1 или 2.")
        except ValueError:
            indent("Введите число.")
    return site_choice
    ...
    while True:
        ...
        if coauthor_name_input:
            ...
            if coauthor_name_input == blog_name_input:
                indent("Введите имя, отличное от основного имени блога.")
            else:
                ...
                if coauthor_name_input == "6020" and site_input == 1:
                    ...
                    if error != 0:
                        ...
                        if coauthor_id == 0:
                            indent("Такая учетная запись не найдена.")
                        else:
                            # Соавтор найден
                            # Проверка завершена
                            break
            ...
            indent("Для книги будут собираться сообщения только одного автора", newline=False)
    ...
    while True:
        ...
        if real_name_input:
            ...
            if real_name_input:
                ...
                indent("Введите корректное имя. Таких имен не бывает.")
        else:
            indent("Ладно, настоящее имя автора блога в книге указываться не будет.")
            break
    ...
    while True:
        ...
        if real_surname_input:
            ...
            if real_surname_input:
                ...
                indent("Введите корректную фамилию. Таких фамилий не бывает.")
        else:
            indent("Ладно, настоящая фамилия автора блога в книге указываться не будет.")
            break
...
def include_images():
    ...
    if include_images_response is True:
        indent("Книга будет включать в себя изображения из блога.")
    else:
        indent("Изображения в блог включены не будут.")
